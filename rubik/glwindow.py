...
class GLWindow(QGLWidget):
	...
	# Initial translation is zero in all directions.
	...
	""" Maps the click location to the sphere and records this in lastPos.
	Also records that dragging has begun.
        """
        x, y = event.x(), event.y()
	...
	will need to either call self.orient_scene() or do your own
